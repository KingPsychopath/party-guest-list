...
const QUESTIONS = [
  {
    ...
    parts: [
      ...
      },
      {
        label: "(b)",
        marks: 4,
        text: "Find the coordinates of the two stationary points of C.",
      },
      {
        label: "(c)",
        marks: 3,
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        label: "(b)",
        marks: 2,
        text: "Find the probability that exactly 2 bolts are defective.",
      },
      {
        label: "(c)",
        marks: 3,
...
export default function ExamPage() {
  ...
  const toggle = useCallback(
    (id: number) => setOpenQ((prev) => (prev === id ? null : id)),
    []
  );
