  ...
  return (
    ...
    >
        ...
        <div className="text-center max-w-sm">
          {!revealed ? (
            <>
              ...
              <p className="text-zinc-400 mb-8">Tap to reveal your colour for tonight</p>
              <button
                onClick={() => {
                  playFeedback('reveal');
                  setRevealed(true);
            ...
            <>
              ...
              <div className="mb-8">
                ...
                />
                <h1 className={`text-5xl font-bold mb-2 ${color.text}`}>{color.name}</h1>
                <p className={`text-lg opacity-80 ${color.text}`}>This is your colour for tonight</p>
              </div>
              ...
              <div className={`rounded-2xl p-5 mb-4 ${color.text} bg-black/20 backdrop-blur-sm`}>
                ...
                <p className="text-lg font-medium leading-relaxed">&ldquo;{question}&rdquo;</p>
              </div>
      ...
      <footer role="contentinfo" className="p-6 text-center space-y-3">
        {/* Footnote */}
        <p
          className={`text-xs max-w-xs mx-auto leading-relaxed opacity-70 ${
