...
export function SearchBar({ searchQuery, onSearchChange, filter, onFilterChange, searchStats }: SearchBarProps) {
        ...
        {searchQuery && (
          <div className="mt-3 flex items-center gap-2 text-sm">
            ...
            <span className="text-stone-500">
              ({searchStats.invites} invite{searchStats.invites !== 1 ? 's' : ''}, {searchStats.plusOnes} guest{searchStats.plusOnes !== 1 ? 's' : ''})
            </span>
          </div>
        )}
      </div>
